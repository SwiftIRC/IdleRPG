...
abstract class Smarty_Internal_TemplateCompilerBase extends stdClass
{
    ...
    public function compileTemplate(Smarty_Internal_Template $template)
    {
        ...
        if (!$this->suppressHeader) {
            $date = new DateTime();
            $template_header .= "<?php /* Smarty version " . Smarty::SMARTY_VERSION . ", created on " . $date->format('Y-m-d H:i:s') . "\n";
