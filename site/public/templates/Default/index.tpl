					...
					<div class="accordion-group">
						...
						<div id="collapseOne" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} REGISTER <character name> <password> <character class>"|htmlspecialchars}</pre>
								<ul>
					...
					<div class="accordion-group">
						...
						<div id="collapseTwo" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} LOGIN <character name> <password>"|htmlspecialchars}</pre>
					...
					<div class="accordion-group">
						...
						<div id="collapseThree" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} LOGOUT"|htmlspecialchars}</pre>
					...
					<div class="accordion-group">
						...
						<div id="collapseFour" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} NEWPASS <new password>"|htmlspecialchars}</pre>
								<p>This is a p0 command. (See <a href="#penalties">Penalties</a>)</p>
							</div>
						</div>
					</div>
					<div class="accordion-group">
						...
						<div id="collapseFive" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} REMOVEME"|htmlspecialchars}</pre>
								<p>This is a p0 command. (See <a href="#penalties">Penalties</a>)</p>
							</div>
						</div>
					</div>
					<div class="accordion-group">
						...
						<div id="collapseSix" class="accordion-body collapse">
							<div class="accordion-inner">
								...
								<pre>{"/msg {$bot} ALIGN <good|neutral|evil>"|htmlspecialchars}</pre>
